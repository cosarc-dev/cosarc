                ...
                Stack(
                  children: [
                    ...
                    AnimatedContainer(
                      ...
                      decoration: BoxDecoration(
                        gradient: LinearGradient(
                          colors: [CosarcColors.gold, CosarcColors.gold.withOpacity(0.6)],
                        ),
                        borderRadius: BorderRadius.circular(10),
                        boxShadow: [
                          BoxShadow(
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          // Food Items
          ...logs.map((log) => _buildFoodItem(log)),
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 30),
              _buildDetailRow("Energy", "${log.calories.toInt()} kcal", CosarcColors.gold),
