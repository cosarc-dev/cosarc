          ...
          child: InkWell(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                ...
                color: completed 
                    ? Color(0xFF2A2A2A).withOpacity(0.85)  // Darker grey when completed
                    : Color(0xFF1A1A1A).withOpacity(0.75), // Medium grey when not completed
                borderRadius: BorderRadius.circular(24),
                border: Border.all(
                  color: completed 
                      ? cosarcPink.withOpacity(0.5)
              ...
              child: Row(
                children: [
                  Container(
                    ...
                    child: Icon(
                      icon,
                      color: completed ? cosarcPink : Colors.white.withOpacity(0.7),
                      size: 24,
                    ),
                  ),
                      ...
                      children: [
                        Text(
                          ...
                          style: GoogleFonts.inter(
                            fontSize: 17,
                            fontWeight: FontWeight.w600,
                            color: Colors.white, // Full white for readability
                          ),
                        ),
                        ...
                        Text(
                          ...
                          style: GoogleFonts.inter(
                            fontSize: 14,
                            color: Colors.white.withOpacity(0.7), // Brighter subtitle
                          ),
                        ),
                      ],
                    ),
                  ...
                  Icon(
                    ...
                    color: completed ? cosarcPink : Colors.white.withOpacity(0.4),
          ...
          children: [
            ...
            ClipRRect(
              ...
              child: LinearProgressIndicator(
                value: progress,
                minHeight: 8,
                backgroundColor: Colors.white.withOpacity(0.15), // Brighter background
        ...
        child: Column(
          children: [
            Icon(
              ...
              color: _contractComplete ? cosarcPink : Colors.white.withOpacity(0.5),
              size: 32,
            ),
            const SizedBox(height: 16),
            Text(
