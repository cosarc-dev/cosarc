...
class _EditProfileScreenState extends State<EditProfileScreen> {
  ...
  final List<String> _goals = ['Not set', 'Weight Loss', 'Muscle Gain', 'Endurance', 'Flexibility', 'General Fitness'];
  final List<String> _activityLevels = ['Not set', 'Sedentary', 'Lightly Active', 'Moderately Active', 'Very Active', 'Super Active'];
  ...
  Future<void> _loadProfile() async {
    try {
      ...
      if (member != null && mounted) {
        ...
        final loadedActivity = member['activity_level']?.toString() ?? 'Not set';
