...
class _DynamicIslandStreakState extends State<DynamicIslandStreak>
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        boxShadow: [
                          ...
                          if (t > 0.3)
                            BoxShadow(
                              color: CosarcColors.gold.withOpacity(0.05 * t),
                              blurRadius: 20,
                              spreadRadius: -2,
                            ),
                        ],
          ...
          Row(
            ...
            children: [
              ...
              Text(
                '${(progress * 100).toInt()}%',
                style: const TextStyle(
                    fontSize: 10, fontWeight: FontWeight.w700, color: CosarcColors.gold),
              ),
            ],
          ),
              ...
              children: [
                ...
                FractionallySizedBox(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      gradient: const LinearGradient(
                          colors: [CosarcColors.gold, _fireOrange]),
                      boxShadow: [
                        BoxShadow(
                            color: CosarcColors.gold.withOpacity(0.35), blurRadius: 4),
                      ],
                    ),
                  ),
                ),
  ...
  Widget _stat(String label, String value, IconData icon) => Expanded(
        child: Column(
          mainAxisSize: MainAxisSize.min,
          children: [
            Icon(icon, size: 12, color: CosarcColors.gold.withOpacity(0.75)),
